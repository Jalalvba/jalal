 ...
 * buildVariants() helper originally inline in src/app/api/sheet/route.ts —
 * extracted here so src/lib/sheets/googleSheetsBdd.ts, src/lib/sheets/googleSheetsRl.ts, and the
