...
export const DS_ANALYSIS_SYSTEM_PROMPT = [
  ...
  '- findings: [{ level: "info"|"warn"|"critical", title: string, detail: string }] — 0 à 6 éléments, les plus significatifs. Couvre DEUX axes quand les données le permettent : récurrence par pièce/organe ET récurrence par prestataire externe (règle 9).',
