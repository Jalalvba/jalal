...
export const DS_PARKING_WORKORDER_PROMPT = [
  ...
  "       ligne « zone Remplacement » que pour un véhicule dont l'ETAT VÉHICULE",
  ...
  "    reformule pas, ne les abrège pas, n'y ajoute rien.",
  "",
  ...
  "    (parc propre / location courte durée), et SEULEMENT dans ce cas : dès",
