...
export const DS_PARKING_WORKORDER_PROMPT = [
  ...
  "       à l'atelier. Cette seule ligne SATISFAIT la règle A4b.",
  ...
  "    réparation.",
  "    Écris : « Remplacer le filtre à gasoil »",
  ...
  "    2) La dernière intervention décrit un problème : écris",
  ...
  "    5) Aucun des quatre niveaux précédents n'a produit UNE SEULE ligne — le",
  "       véhicule est sain et à jour : écris alors exactement",
  "       « Disponible — à livrer au client ». C'est la zone",
  "       « DISPONIBLE_À LIVERER » de cet onglet, et c'est une consigne réelle :",
  "       le véhicule est prêt et quelqu'un doit le livrer.",
  ...
  "    Dans ce cas, la ligne « Disponible — à livrer au client » est INTERDITE :",
  "    un véhicule qui a quelque chose à contrôler n'est pas prêt à partir.",
  ...
  '  "actions": [',
  '    "Diagnostiquer manque de puissance et témoin moteur allumé",',
