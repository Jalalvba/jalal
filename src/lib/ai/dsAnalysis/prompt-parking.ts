...
export const DS_PARKING_WORKORDER_PROMPT = [
  ...
  "       exactement celle-ci : « Envoyer en zone dépôt ATV ». Ne liste ni",
  "       entretien dépassé ni récurrence : ce véhicule ne passe pas à",
  "       l'atelier.",
  ...
  "       LIGNE : « Envoyer en zone dépôt Remplacement ».",
  "    d) Tout autre statut (« LLD », « LCD », « En stock », « Livré », statut",
  "       absent) : rien de particulier, applique A1 à A5 normalement.",
  "",
  "    Ces consignes de zone (« Envoyer en zone dépôt ... ») sont les SEULES",
  "    actions que tu écris sans fait chiffré entre parenthèses : elles",
  "    découlent du statut, pas de l'historique.",
  "",
