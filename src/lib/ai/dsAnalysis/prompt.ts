...
export const DS_ANALYSIS_SYSTEM_PROMPT = [
  ...
  "15. Le contrôle du GRADE D'HUILE t'est fourni déjà calculé. Il ne se déclenche que dans un cas : le véhicule est déjà passé à un grade de référence, puis une intervention ULTÉRIEURE en a utilisé un autre. Cette application ne connaît AUCUN grade prescrit par le constructeur : n'affirme jamais qu'un grade est le bon ou le mauvais pour ce moteur, ne recalcule rien, et présente le constat comme un écart à vérifier par un humain. Si ce contrôle ne figure pas dans les données fournies, n'en parle pas et n'en déduis rien.",
  "",
  "Champs attendus :",
