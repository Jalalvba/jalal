...
/** localStorage key hooks/queryClient.tsx's persister writes the BDD query cache under — must match that file's `key` exactly. */
 ...
 * the in-memory query cache. app/login/actions.ts's logout() server action
 ...
 * action is invoked (see the three call sites: app/page.tsx,
 * components/fleet/ListPageHeader.tsx, app/ds-history/page.tsx).
 */
